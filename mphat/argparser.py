...
def add_common_args(parser=None):
    ...
    commongroup = parser.add_argument_group('General Shared Parameters')
    commongroup.add_argument('-W', '--west', '--WEST_H5FILE', '--west-h5file', dest='west_name', default="west.h5",
    ...
    commongroup.add_argument('-A', '--assign', '--assign-h5file', '--ASSIGN-H5FILE', dest='assign_name',
                             default='ANALYSIS/TEST/assign.h5',
                             help='Path to your ``assign.h5`` file for WE simulations. \
                                   Not used if analyzing an MD trajectory.')

    commongroup.add_argument('-r', '--rcfile', metavar='RCFILE', dest='rcfile', default='west.cfg',
    ...
    commongroup.add_argument('-od', '--out-dir', '--output-directory', dest='out_dir', default='succ_traj',
                             type=str, help='Directory to save your output files.')
...
def add_discretize_args(parser):
    ...
    discrete_io.add_argument('-i', '-I', '--input', dest='input_name', default="west.h5",
                             ...
                             features.')
    discrete_io.add_argument('-o', '-O', '--output', dest='output_name', default="states.npy",
