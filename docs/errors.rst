...
This page details common errors you might encounter while using ``mPHAT``.
...
The following tracebacks imply that your states have all accidentally been cleared out by the ``expand_shorter_traj()`` function::
    Traceback(most recent call last):
      File "/home/user/apps/miniconda3/envs/westpa-mphat/bin/mphat", line 8, in <module>
        sys.exit(entry_point())
                 ^^^^^^^^^^^^^
      File "/home/user/Documents/mPHAT/mphat/mphat.py", line 52, in entry_point
        args.func(args)
      File "/home/user/Documents/mPHAT/mphat/match.py", line 492, in main
        dist_matrix, weights = gen_dist_matrix(pathways, dictionary, file_name=arguments.dmatrix_save,
                               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/atb43/Documents/mPHAT/mphat/match.py", line 280, in gen_dist_matrix
    ...
    Traceback (most recent call last):
      File "/home/atb43/apps/miniconda3/envs/westpa2-ibstates-fix/bin/mphat", line 8, in <module>
        sys.exit(entry_point())
                 ^^^^^^^^^^^^^
      File "/home/atb43/Documents/mPHAT-stride/mphat/mphat.py", line 52, in entry_point
        args.func(args)
      File "/home/atb43/Documents/mPHAT-stride/mphat/match.py", line 601, in main
        dist_matrix, weights = gen_dist_matrix(pathways, dictionary, file_name=arguments.dmatrix_save,
                               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/atb43/Documents/mPHAT-stride/mphat/match.py", line 392, in gen_dist_matrix
      ...
      File "/home/atb43/apps/miniconda3/envs/westpa2-ibstates-fix/lib/python3.11/site-packages/sklearn/metrics/pairwise.py", line 1623, in _pairwise_callable
        out[i, j] = metric(X[i], Y[j], **kwds)
                    ^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/atb43/Documents/mPHAT-stride/mphat/match.py", line 393, in <lambda>
        X=path_strings, metric=lambda x, y: calc_dist(x, y, dictionary)
                                            ^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/atb43/Documents/mPHAT-stride/mphat/match.py", line 69, in calc_dist
